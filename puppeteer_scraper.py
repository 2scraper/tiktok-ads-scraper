#!/usr/bin/env python3
"""puppeteer_scraper.py — TikTok's EU Ad Library.

    python3 puppeteer_scraper.py --region DE
    python3 puppeteer_scraper.py --region DE,FR,GB --pages 5 --format both
    python3 puppeteer_scraper.py --region IT --query nike --days 90
